...
public class FileSuffix {
  ...
  public static final String OFCS = TXT + Chars.SEMICOLON + DOC + Chars.SEMICOLON + XLS
      + Chars.SEMICOLON + PPT + Chars.SEMICOLON + PDF;
  ...
  public static final String IMGS =
      JPG + Chars.SEMICOLON + GIF + Chars.SEMICOLON + PNG + Chars.SEMICOLON + BMP;
