...
public class BitCodeTest {
  @Test
  public void test() {
    BitCode code1 = new BitCode("10101010101010101010101010101011010101010101010101010101010101");
    BitCode code2 = new BitCode("01010101010101010101010101010100101010101010101010101010101010");
