...
public class BeanUtils {
  ...
  public static Object getField(Object target, Field field) {
    if (target == null || field == null) {
      throw new UncheckedException("对象或属性不能为null。");
    }
    try {
  ...
  public static void setField(Object target, Field field, Object value) {
    ...
    try {
      ...
      throw new UncheckedException("设置对象的属性[" + field.getName() + "]值失败", e);
    }
  }
  ...
  private static Field findDirectField(Class<?> targetClass, String fieldName) {
    ...
    throw new UncheckedException("类[" + targetClass.getName() + "]中未找到属性[" + fieldName + "]。");
  }
  ...
  private static void setNestedField(Object target, String fieldName, Object value) {
    ...
    for (String nestedFieldName : nestedFieldNames) {
      if (target != null) {
        ...
        throw new UncheckedException("未找到多层级属性：" + fieldName);
      }
    }
  ...
  private static void checkSourceAndTarget(Object source, Object target) {
    if (source == null || target == null) {
      throw new UncheckedException("参与复制的源对象和目标对象都不能为null。");
    }
  }
