...
public class BeanUtilsTest {
	...
	public void test() {
		...
		BeanUtils.setField(nestedBean1, "nestedBean.nestedBean.name",
				"changed name");

		log.debug("{}", BeanUtils.findField(NestedBean.class,
				"nestedBean.nestedBean.nestedBean.name"));
		log.debug("{}",
				BeanUtils.getField(nestedBean1, "nestedBean.nestedBean.name"));
	}
}
