	...
	$.extend($.fn, {
		comboxSelect: function(options) {
			...
			return this.each(function() {
				...
				allSelectBox.push(box.attr("id").escape());
				$(op.selector, box).click(function() {
					var options = $("#op_" + box.attr("id").escape());
				...
				$("#op_" + box.attr("id").escape()).find(">li").comboxOption(selector, box);
			});
		},
