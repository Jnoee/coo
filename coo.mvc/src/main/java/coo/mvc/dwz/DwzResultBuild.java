...
import coo.mvc.handler.GenericJackson2JsonView;
...
public class DwzResultBuild {
  ...
  public ModelAndView build() {
    ...
    GenericJackson2JsonView view = new GenericJackson2JsonView();
   ...
   * @return 返回构建器。
   */
  public DwzResultBuild forwardNavTab(String url, String params, String callback) {
   ...
   * @return 返回构建器。
   */
  public DwzResultBuild forwardNavTab(String navTabId, String url, String params, String callback) {
   ...
   * @return 返回构建器。
   */
  public DwzResultBuild forwardDialog(String url, String params, String callback) {
   ...
   * @return 返回构建器。
   */
  public DwzResultBuild forwardDialog(String dialogId, String url, String params, String callback) {
