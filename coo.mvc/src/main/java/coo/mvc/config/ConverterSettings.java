...
import coo.mvc.converter.AbstractConverterSettings;
 ...
 * 转换器配置组件。
 */
@Component("coo.mvc.config.ConverterSettings")
public class ConverterSettings extends AbstractConverterSettings {
  @Override
