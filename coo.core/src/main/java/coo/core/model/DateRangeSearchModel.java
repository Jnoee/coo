...
public class DateRangeSearchModel extends SearchModel {
  ...
  public Query genQuery(String searchField) {
    ...
    if (endDate != null) {
      ...
      endDateStr = DateUtils.format(endDateTime.toDate(), DateUtils.MILLISECOND_N);
    }
    return TermRangeQuery.newStringRange(searchField, startDateStr, endDateStr, true, false);
  }
