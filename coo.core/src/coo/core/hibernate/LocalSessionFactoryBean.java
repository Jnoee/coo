...
public class LocalSessionFactoryBean extends
    org.springframework.orm.hibernate5.LocalSessionFactoryBean implements ApplicationContextAware {
  private List<AbstractLocalSessionSettings> settings =
      new ArrayList<AbstractLocalSessionSettings>();
