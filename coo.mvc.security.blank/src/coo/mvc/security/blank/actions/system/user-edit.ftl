...
<div class="page">
    <div class="pageContent">
    	<@dwz.form action="/system/user-update" targetType="dialog">
	    	...
	    	<div class="pageFormContent" layoutH="58">
	            ...
	            <div class="divider"></div>
	            <div class="panel">
	                <h1>职务列表[<@dwz.a href="/system/actor-add?userId=${user.id}" target="dialog" width="M" height="M">新增职务</@dwz.a>]</h1>
	                <div>
	                        ...
	                        <tbody>
	                            <#list user.actors as actor>
		                            <tr>
		                                ...
		                                <td align="center">
		                                    <@dwz.a href="/system/actor-edit?actorId=${actor.id}" target="dialog" width="M" height="M" title="编辑职务">编辑</@dwz.a>
